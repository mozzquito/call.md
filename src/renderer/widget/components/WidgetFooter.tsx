...
function MicIcon({ muted = false }: { muted?: boolean }) {
  return (
    <svg className={muted ? 'text-red-500' : 'text-foreground'} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function PauseIcon() {
  return (
    <svg className="text-foreground" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="5" y="3.5" width="3.75" height="13" rx="1" fill="currentColor" />
      <rect x="11.25" y="3.5" width="3.75" height="13" rx="1" fill="currentColor" />
    </svg>
  );
}
...
export function WidgetFooter({
  ...
  return (
    <div
      className="flex items-center justify-center border-t border-border bg-card"
      style={{
        height: '72px',
        padding: '12px 16px',
        gap: '8px',
    ...
    >
      ...
      <button
        ...
        className={`flex items-center justify-center shrink-0 border bg-card transition-colors ${
          isMicMuted
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center gap-1.5 border border-border bg-card hover:bg-secondary transition-colors"
        style={{
          height: '40px',
          borderRadius: '12px',
      ...
      <button
        onClick={onStop}
        className="flex items-center justify-center gap-1 shrink-0 bg-destructive transition-all hover:bg-destructive/90"
        style={{
          borderRadius: '12px',
