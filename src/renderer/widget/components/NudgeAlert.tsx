...
function AlertIcon() {
  return (
    <svg className="text-amber-700 dark:text-amber-400" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
function CloseIcon() {
  return (
    <svg className="text-amber-700 dark:text-amber-400" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 4L4 12"
        stroke="currentColor"
        strokeWidth="1.5"
...
export function NudgeAlert({ message, onDismiss }: NudgeAlertProps) {
  return (
    <div
      className="w-full flex items-center border border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/30"
      style={{
        height: '61px',
        padding: '8px 12px',
        borderRadius: '12px',
