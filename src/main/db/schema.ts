...
export const recordings = sqliteTable('recordings', {
  ...
  // SHA-256 of the imported file's contents, for duplicate-import detection.
  // Null for live recordings (nothing to hash).
  importedFileHash: text('imported_file_hash'),
